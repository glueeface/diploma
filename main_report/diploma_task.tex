...
\newgeometry{left=3cm,right=1.5cm,top=2.0cm,bottom=2.0cm,twoside}
    ...
    \begin{tabular}{ @{}b{0.45\textwidth}b{0.30\textwidth}b{0.25\textwidth} }
      Консультант по дипломному проектированию: & \underline{\hspace*{4.75cm}} & Ю.Ю. Желтко%\diplomaTutorShort
    \end{tabular}
    ...
    \begin{tabular}
      ...
      \hline
      Подбор и изучение литературы & 10 & 25.03 – 30.03 & \\ \hline %. Сравнение аналогов. Уточнение задания на ДП
